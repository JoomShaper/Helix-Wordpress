<div class="sp-template-desc">
	...
	<div class="row-fluid">
		<div class="span5">
			<img class="img-polaroid pull-left" style="margin-right:15px;" src="<?php echo Helix::themeURI(); ?>/screenshot.png" alt=" " />
			<h2>Overview</h2>
			<p id="sp-theme-info" class="clearfix">	
				<?php echo wp_get_theme()->description; ?>
			</p>
		</div>
		...
		<div class="span7">
			<div class="sp-block sp-style1">
				...
				<div class="sp-content">
					<h3>Version 1.0.2 <small>(Alpha)</small></h3>
					<p>
						...
						<br />
						<strong>More Information</strong> <a target="_blank" href="http://www.joomshaper.com/helix/wordpress">http://www.joomshaper.com/helix/wordpress</a>
					</p>
				</div>
			</div>

			<div class="sp-block sp-style2">
				<h2><i class="icon-thumbs-up"></i> Helix Features
					<div class="pull-right sp-indicators">
						<a href="#myCarousel" data-slide="prev"><i class="icon-angle-left"></i></a>
						<a href="#myCarousel" data-slide="next"><i class="icon-angle-right"></i></a>
					</div>
				</h2>
